...
export function PhaserGame() {
  ...
  useEffect(() => {
    ...
    const worldScenes = ['TownScene', 'GreenhollowScene', 'MossbarrowScene', 'MossbarrowDepthsScene', 'DepthsFloor2Scene', 'DepthsFloor3Scene', 'AshenmereScene', 'InteriorScene', 'CombatScene'];
